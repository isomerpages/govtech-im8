...
description: ""
---
The Low-Risk On-Premises System Security Plan template includes Level 0 and Level 1 baseline controls that are recommended as the default controls for low-risk on-premises systems. Agencies may customise this template to create their own system-specific System Security Plan or use it as a default System Security Plan for generic low-risk on-premises systems.
