...
| Network | network | Contains and connects the hosts and services of the system. |
...
| Web Defacement Monitoring Service | service | Monitors system assets for defacement. |
| Government Cyber Security Operations Centre (GCSOC) Integration | service | Integration of logs with GCSOC. |
...
| Host | physical | Runs system workloads. |
| Hardware Asset | physical | Performs computation, data storage, processing, and communication functions. |
| Storage Device | physical | Stores data. |
| Data Centre | physical | Houses computer systems. |
...
Run [st-1_prm_1: authenticated network-based] vulnerability assessment scans for eligible hosts.
...
* Vulnerability Assessment Scanner: Maintainers set up vulnerability assessment scans with the vulnerability assessment service.
#### References
...
* Network: Developers segment public and private resources and subnets in the network.
#### References
...
* Network: Developers deny network communications traffic by default in the network.
#### References
...
* Network: Developers route network traffic between on-premises systems and GCC systems through a secure intermediary.
...
* Network: Maintainers set up an Intrusion Prevention System (IPS)/Intrusion Detection System (IDS) in the network.
#### References
...
* Network: Maintainers implement strong access controls for access to private networks.
#### References
...
* **Group:** [Network Security](/catalog/ns)
* **Profile:** [Low-Risk - Level 2](/profiles/low-risk/level-2)
...
* Network: Maintainers implement automated alerts on firewall rule changes.
#### References
...
* Storage Device: Maintainers sanitise all hardware that stores data at rest.
#### References
...
* : Maintainers store event logs in a separate account.
...
* Government Cyber Security Operations Centre (GCSOC) Integration: Maintainers sends logs to Government Cyber Security Operations Centre (GCSOC).
#### References
...
* Web Defacement Monitoring Service: Maintainers configure web defacement monitoring and response.
#### References
...
Disable or remove accounts with developer, maintainer, or administrator access within [ac-3_prm_1: 90 days] day(s) from last day of authorised use or have not been used for [ac-3_prm_2: 90 days] day(s).
...
* System: Administrators change default credentials in any component in the system.
#### References
...
* Source Code: Administrators use SingPass or CorpPass to authenticate users of digital services.
#### References
...
* Identity and Access Management Service: Administrators implement automation of account provisioning and deprovisioning using the identity and access management service.
#### References
...
* Host: Maintainers restrict administrator privileges in hosts.
#### References
...
* Host: Maintainers disable or remove unnecessary functions in hosts.
#### References
...
* Host: Maintainers harden the operating systems of hosts.
#### References
...
* Compute Management Service: Detect and quarantine malware on hosts with anti-malware tools
#### References
...
* Host: Maintainers implement Endpoint Detection and Response (EDR) tools on hosts.
#### References
...
Ensure deployed [is-9_prm_1: hardware] assets have not reached end-of-support (EOS). Use of EOS assets will require risk acceptance by approved authority.
...
* Hardware Asset: Maintainers ensure end-of-support hardware assets are removed or replaced.
#### References
...
* Data Centre: System owners physically separate Government resources from non-Government resources in the data centre.
#### References
...
* Data Centre: System owners implement physical access controls to prohibit unauthorised access in the data centre.
#### References
